        ...
        <form className='form' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div className='submitButtons'>
              <button name='post' type='submit' className='presetButtons'>Save As</button>
              <button name='load' type='submit' className='presetButtons'>Load</button>
              <button name='edit' type='submit' className='presetButtons edit'>Update
              </button>
              <button name='delete' type='submit' className='presetButtons'>Delete</button>
            </div>
          </div>
        </form>
      </container>
